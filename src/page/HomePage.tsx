    ...
    return (
        ...
        >
            <div className="w-1/2 max-w-3xl min-w-[min(100%,var(--container-lg))] px-4 flex flex-col justify-center items-center">
                ...
                >
                    <div className="text-6xl">Covid-19</div>
                    <div className="text-4xl">Article Search</div>
                </div>
                <GlobalSearch autoFocus={true} />
                <div className="flex flex-col items-center justify-center space-x-3 mt-8">
                    <Link
                        to="/random"
                        className="text-sm inline-flex gap-2 items-center text-content/50 hover:text-content/60 align-middle"
                        viewTransition
                    >
                        Feeling lucky?
